...
function get_copyright() {
    ...
    return '&copy; Copyright ' . date('Y') . ' ' . get_bloginfo('name') . '<br/>All Rights Reserved | Created By: <a href="https://getmemorehomeinspectionsnow.com/" target="_blank" rel="noopener">THE SAVVY INSPECTOR</a>';
...
function get_created_by() {
    ...
    return 'Created By: <a href="https://getmemorehomeinspectionsnow.com/" target="_blank" rel="noopener">THE SAVVY INSPECTOR</a>';
